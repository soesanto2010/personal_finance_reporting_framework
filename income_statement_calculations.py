...
def calculate_financial_KPIs(self):
    ...
    total_assets = self.Class_Level_Summary[self.Class_Level_Summary["acc_A_L_E_classification"] == "Asset"]["MV"].sum()
    ...
    total_liabilities = self.Class_Level_Summary[self.Class_Level_Summary["acc_A_L_E_classification"] == "Liability"]["MV"].sum()
