...
def verify_accounting_equation(self):
    ...
    LHS = self.Class_Level_Summary[(self.Class_Level_Summary["acc_A_L_E_classification"]=="Asset") & (self.Class_Level_Summary["acc_A_L_E_sign"]=="[+ve]")]["MV"].sum() - self.Class_Level_Summary[(self.Class_Level_Summary["acc_A_L_E_classification"]=="Asset") & (self.Class_Level_Summary["acc_A_L_E_sign"]=="[-ve]")]["MV"].sum()
    RHS = self.Class_Level_Summary[(self.Class_Level_Summary["acc_A_L_E_classification"]!="Asset") & (self.Class_Level_Summary["acc_A_L_E_sign"]=="[+ve]")]["MV"].sum() - self.Class_Level_Summary[(self.Class_Level_Summary["acc_A_L_E_classification"]!="Asset") & (self.Class_Level_Summary["acc_A_L_E_sign"]=="[-ve]")]["MV"].sum()
